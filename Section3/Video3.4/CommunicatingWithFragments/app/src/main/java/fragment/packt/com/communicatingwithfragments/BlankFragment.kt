...
class BlankFragment : Fragment() {
    ...
    fun onButtonPressed(textFromFrg: String) {
        listener?.onFragmentInteraction(textFromFrg)
    }
    ...
    override fun onResume() {
        super.onResume()
        listener?.onFragmentInteraction("Hello Fragment 2")
    ...
    interface OnFragmentInteractionListener {
        ...
        fun onFragmentInteraction(textFromFrg: String)
    }
